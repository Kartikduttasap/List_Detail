					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Fiori List Detail App",
									"targetURL": "#nslistdet-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nslistdet-display": {
								"semanticObject": "nslistdet",
								"action": "display",
								"description": "Fiori List Detail App",
								"title": "Fiori List Detail App",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ns.listdet",
									"url": sap.ui.require.toUrl("ns/listdet")
								}
							}
						}
					}
